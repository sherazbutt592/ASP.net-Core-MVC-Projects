    ...
    public partial class AddedSeedingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "This is the description of first movie", new DateTime(2025, 9, 26, 20, 10, 44, 901, DateTimeKind.Local).AddTicks(3240), "movie1.jpg", 0, "Movie 1", 30.0, 2, new DateTime(2025, 9, 19, 20, 10, 44, 899, DateTimeKind.Local).AddTicks(7878) },
                    { 2, 2, "This is the description of second movie", new DateTime(2025, 9, 26, 20, 10, 44, 901, DateTimeKind.Local).AddTicks(3732), "movie2.jpg", 2, "Movie 2", 45.0, 2, new DateTime(2025, 9, 19, 20, 10, 44, 901, DateTimeKind.Local).AddTicks(3729) },
                    { 3, 3, "This is the description of third movie", new DateTime(2025, 9, 26, 20, 10, 44, 901, DateTimeKind.Local).AddTicks(3739), "movie3.jpg", 0, "Movie 3", 40.0, 3, new DateTime(2025, 9, 19, 20, 10, 44, 901, DateTimeKind.Local).AddTicks(3738) }
                });
